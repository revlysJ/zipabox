	...
	<div class="col-lg-2 col-md-3 col-sm-4">
		<div class="bs-sidebar">
			<ul id="ul_eqLogic" class="nav nav-list bs-sidenav">
				<a class="btn btn-warning eqLogicAction" style="width : 100%;margin-top : 5px;margin-bottom: 5px;" data-action="gotoPluginConf"><i class="fa fa-plus-circle"></i> {{Ajouter une Zipabox}}</a>
...
foreach ($eqLogics as $eqLogic) {
  ...
  <div class="eqLogicThumbnailContainer">
	...
	<div class="cursor eqLogicAction" data-action="ZI_import" style="text-align: center; background-color : #ffffff; height : 120px;margin-bottom : 10px;padding : 5px;border-radius: 2px;width : 160px;margin-left : 10px;">
		<i class="fa fa-sign-in fa-rotate-90" style="font-size : 6em;color:#f89406;"></i>
		<br>
...
<div role="tabpanel" class="tab-pane" id="commandtab">
	    <a class="btn btn-info btn-sm pull-right" id="bt_addzipaboxInfo" style="margin-top:5px;"><i class="fa fa-plus-circle"></i> {{Ajouter une commande info}}</a>
    <a class="btn btn-warning btn-sm  pull-right" id="bt_addzipaboxAction" style="margin-top:5px;"><i class="fa fa-plus-circle"></i> {{Ajouter une commande Action}}</a><br/><br/>
